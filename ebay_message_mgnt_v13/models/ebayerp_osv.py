...
import sys
from custom.ebay_connector_v13.ebay_odoo_v13.models.ebayerp_osv import Call, Session
import logging
...
# sys.path.append("/odoo/custom/addons/ebay_odoo_v13/models")
...
class ebayerp_osv(models.Model):
    ...
    def call(self, referential, method, *arguments):
        if method == 'GetMemberMessages':
            ...
            messages_ebay = GetMyMessages(referential.dev_id, referential.app_id, referential.cert_id,
                                          referential.auth_token, referential.server_url)
            result = messages_ebay.Get(arguments[0], arguments[1], arguments[2])
            return result
        elif method == 'AddMemberMessageRTQ':
            messages_ebay = AddMemberMessageRTQ(referential.dev_id, referential.app_id, referential.cert_id,
                                                referential.auth_token, referential.server_url)
