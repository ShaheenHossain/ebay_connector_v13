...
class sales_channel_instance(models.Model):
    ...
    def _get_installed_module(self):
        ...
        sele_ids = sel_obj.search([('name', 'in',
                                    ['magento_2_v10', 'magento_odoo_v10', 'ebay_odoo_v13', 'amazon_odoo_v11',
    ...
    def _get_default_image(self):
        ...
        if self.module_id == 'ebay_odoo_v13':
            image_path = get_module_resource('base_ecommerce_v13', 'static/images', 'EBay_logo.png')

        if self.module_id == 'magento_odoo_v10':
            image_path = get_module_resource('base_ecommerce_v13', 'static/images', 'logomagento.png')

        if self.module_id == 'shopify_odoo_v10':
            image_path = get_module_resource('base_ecommerce_v13', 'static/images', 'shopify.png')
